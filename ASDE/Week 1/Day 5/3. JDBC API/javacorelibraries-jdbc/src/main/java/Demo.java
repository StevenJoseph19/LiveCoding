...
public class Demo {
	...
	public static void main(String[] args) throws Exception {
		...
		try {
			switch (args[0]) {
			case "m2c1":
				com.mycompany.corejdbc.m2c1.Main.main(null);
				break;
			case "m3c1":
				com.mycompany.corejdbc.m3c1.Main.main(null);
				break;
			case "m3c2":
				com.mycompany.corejdbc.m3c2.Main.main(null);
				break;
			case "m3c3":
				String mainToRun = args[1];
				if (mainToRun.equalsIgnoreCase("JEE")) {
					com.mycompany.corejdbc.m3c3.Main_JEE.main(null);
				} else if (mainToRun.equalsIgnoreCase("CDI")) {
					com.mycompany.corejdbc.m3c3.Main_CDI.main(null);
				} else {
				...
				break;
			case "m4c1":
				com.mycompany.corejdbc.m4c1.Main.main(null);
				break;
			case "m4c2":
				if (args.length == 2) {
					if (args[1].equalsIgnoreCase("TCF")) {
						com.mycompany.corejdbc.m4c2.Main_TCF.main(null);
						break;
					} else if (args[1].equalsIgnoreCase("TwR")) {
						com.mycompany.corejdbc.m4c2.Main_TwR.main(null);
						break;
					} else if (args[1].equalsIgnoreCase("TwR2")) {
						com.mycompany.corejdbc.m4c2.Main_TwR2.main(null);
						break;
					}
				}
				...
				break;
			case "m4c3":
				com.mycompany.corejdbc.m4c3.Main.main(null);
				break;
			case "m4c4":
				com.mycompany.corejdbc.m4c4.Main.main(null);
				break;
			case "m4c5":
				com.mycompany.corejdbc.m4c5.Main.main(null);
				break;
			case "m4c6":
				com.mycompany.corejdbc.m4c6.Main.main(null);
				break;
			case "m5c1":
				com.mycompany.corejdbc.m5c1.Main.main(null);
				break;
			case "m5c2":
				com.mycompany.corejdbc.m5c2.Main.main(null);
				break;
			case "m5c3":
				com.mycompany.corejdbc.m5c3.Main.main(null);
				break;
			case "m5c4":
				com.mycompany.corejdbc.m5c4.Main.main(null);
				break;
