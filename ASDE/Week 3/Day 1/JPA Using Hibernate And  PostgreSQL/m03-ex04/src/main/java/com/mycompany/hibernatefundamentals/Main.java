...
public class Main {
	...
	public static void main(String[] args) {
		...
		em.persist(ticket1);
		em.flush();
		System.out.println("Generated Id ..." + ticket1.getId());
...
//		Ticket	foundTicket = em.createQuery("SELECT t FROM Ticket t WHERE t.id = 1", Ticket.class).getSingleResult();
//		System.out.println("The ticket with Id 1  as found by find() is: " + foundTicket);
//		System.out.println("The ticket with Id 1  as found by find() has the origin as: " + foundTicket.getOrigin());
//		System.out.println("The ticket with Id 1  as found by find() has the destination as: " + foundTicket.getDestination());
...
//		Using Criteria API
		...
		for (Ticket ticket : results) {
			...
			System.out.println("Found ticket from Criteria API has the origin as: " + ticket.getOrigin());
			System.out.println("Found ticket from Criteria API has the destination as: " + ticket.getDestination());
		}
